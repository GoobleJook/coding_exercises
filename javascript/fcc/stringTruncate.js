// Truncates a string, using the following requirements:
// runcate a string (first argument) if it is longer than
//  the given maximum string length (second argument). Return the
