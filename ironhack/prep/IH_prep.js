...
addSequence(15);
console.log("That was addSequence\n")
...
printMinimum(2,strs);
console.log("That was printMinimum\n")
...
var words1 = [ "January", "lacks", "caveats", "hazardous", "DOORS", "crying", "arrogantly", "climate", "proponent", "rebuttal" ];

var words2 = [ "Issuing", "anecdotal", "reticles", "selecting", "recurring", "nodes", "belonging", "externally", "braziers" ];
...
console.log(message);
console.log(decode(words1));
console.log(decode(words2));
console.log("That was decode\n");
/*
D. Array looper
...
function looper (arr, strg ){
    if (strg === "forwards"){
        ...
        console.log("That was looper forwards\n");
        } else if (strg === "backwards") {
            for (i = arr.length -1; i >= 0; i--){
                console.log(arr[i]);
            }
        console.log("That was looper backwards\n");
        } else if (strg === "evens") {
            for (i = 0; i < arr.length; i += 2){
                console.log(arr[i]);
            }
        console.log("That was looper evens\n");    
            
        } else if(strg === "odds") {
            for (i = 1; i < arr.length; i += 2){
                console.log(arr[i]);
            }
        console.log("That was looper odds\n");
        }
        else{
